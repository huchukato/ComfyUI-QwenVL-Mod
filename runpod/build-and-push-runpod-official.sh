...
# ComfyUI-QwenVL-Mod v2.2.0 RunPod Official Build Script
# Automates building and pushing Docker image with official RunPod approach (no conda)
...
echo "🚀 Building ComfyUI-QwenVL-Mod v2.2.0 RunPod Official Docker Image"
echo "==============================================================="
...
docker buildx build --builder desktop-linux --platform linux/amd64 -f Dockerfile.runpod-official -t "${FULL_IMAGE_NAME}" --load --no-cache .
...
echo "  Dockerfile:   Dockerfile.runpod-official"
...
echo "  4. Select GPU: RTX 4090/5090 or A100"
